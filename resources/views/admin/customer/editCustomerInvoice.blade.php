                                            ...
                                            <div class="">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ number_format($invoice->payment->paid_amount) }}
                                                                </td>
                                                            </tr>
                                                            @if ($invoice->payment->due_amount)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ number_format($invoice->payment->due_amount) }}
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                            <tr>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class=" form-group col-md-3">
                                                        <div class="md-3">
                                                            <button type="submit"
                                                                class="px-3 py-2 mt-[1.8rem] font-semibold text-white bg-blue-900 rounded-lg hover:bg-blue-800">Update
                                                                Invoice </button>
                                                        </div>
                                                    </div>
